...
# -*- coding: utf-8 -*-
"""
Extração Judicial EMCCAMP - AUTOJUR + MAX Smart
Extrai dados judiciais específicos para EMCCAMP.
"""
import os
import sys
import time
...
# Query AUTOJUR - Banco Candiotto/Autojur - EMCCAMP
SQL_AUTOJUR_EMCCAMP = """
SELECT DISTINCT 
...
# Query MAX Smart Judicial - Banco STD - Campanha 4
...
def main():
    print("=" * 60)
    print("  EXTRAÇÃO JUDICIAL EMCCAMP")
    print("=" * 60)
    print()
    ...
    output_file = output_dir / "ClientesJudiciais_EMCCAMP.zip"
    ...
    if unicos.empty:
        print("\n[AVISO] Nenhum dado judicial EMCCAMP encontrado.")
        return
    ...
    csv_name = f"ClientesJudiciais_EMCCAMP_{timestamp}.csv"
    ...
    print()
    print("[OK] Judicial EMCCAMP extraído com sucesso!")
