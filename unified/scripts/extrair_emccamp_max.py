...
# -*- coding: utf-8 -*-
"""
Extração EMCCAMP MAX - SQL Server
Extrai a base MAX do SQL Server para EMCCAMP.
"""
import os
import sys
import time
...
# Query SQL para extração EMCCAMP MAX
# MoClientesID = 77398 (EMCCAMP)
SQL_EMCCAMP_MAX = """
SELECT DISTINCT
...
def main():
    print("=" * 60)
    print("  EXTRAÇÃO EMCCAMP MAX - BASE SQL SERVER")
    print("=" * 60)
    print()
    ...
    # Configuração
    output_dir = ROOT / "data" / "input" / "base_max"
    ...
    print(f"  Cliente: EMCCAMP (MoClientesID = 77398)")
    print()
    ...
    print()
    print("[OK] EMCCAMP MAX extraído com sucesso!")
